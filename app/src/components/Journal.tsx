                        ...
                        <div>
                            <div>
                                <h1 className="text-center text-5xl font-bold text-transparent bg-clip-text text-[#89eb34] mb-6">
                                    <p>{journal.nickname}<span className="text-[#68ccca]"> Alerts</span></p>
                                </h1>
                                <div className="border-2 rounded-lg border-[#6e6e6e] px-4 py-2 bg-[#1f1f1f]">
                                    <input className="w-96 h-12 text-black px-4 rounded-md"
                                        type="text" placeholder="Write incident's Latitude, Longitude, Description." 
